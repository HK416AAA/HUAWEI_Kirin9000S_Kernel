...
DEFINE_TRACE(ext4_da_write_begin_end,
	TP_PROTO(struct inode *inode, loff_t pos, unsigned int len, unsigned int flags),
...
ext4_readpages(struct file *file, struct address_space *mapping,
		struct list_head *pages, unsigned nr_pages, struct readahead_control *rac)
{
	struct inode *inode = mapping->host;
	...
	return ext4_mas_mpage_readpages(inode, rac, NULL, pages);
}
#endif
