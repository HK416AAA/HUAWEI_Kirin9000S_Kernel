...
#define DIFF_SOURCE_HACTIVE_PIXELS 1920
#define DIFF_SOURCE_VACTIVE_PIXELS 1080
	...
	struct timing_info *per_timing_info, uint32_t fps, uint32_t fps_default)
{
	...
	if (dptx_timing_node->hactive_pixels > MAX_HACTIVE_PIXELS ||
		...
		(dptx_timing_node->hactive_pixels == DIFF_SOURCE_HACTIVE_PIXELS &&
		dptx_timing_node->vactive_pixels != DIFF_SOURCE_VACTIVE_PIXELS) ||
		(dptx_timing_node->hactive_pixels != DIFF_SOURCE_HACTIVE_PIXELS &&
		dptx_timing_node->vactive_pixels == DIFF_SOURCE_VACTIVE_PIXELS)) {
